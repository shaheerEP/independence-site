        ...
        <div className="stories-grid">
          <div className="story-card">
            ...
            <p>
              ...
              الاختلافات الدينية، قال أشفاق: "ديني هو حب الوطن". قبل إعدامهما، طلبا 
          ...
          <div className="story-card">
            ...
            <p>
              ...
              أجابت: "سأكون حزينة لو كان أولادي جبناء. أنا فخورة لأنهم اختاروا السجن 
              بدلاً من خدمة البريطانيين". كلماتها ألهمت آلاف الأمهات لإرسال أولادهن للنضال.
            </p>
          </div>
          ...
          <div className="story-card">
            ...
            <p>
              ...
              إذا اعتذر. رفض الإمبراطور البالغ من العمر 82 عاماً وقال: "قد أكون عجوزاً، 
              لكن ضميري ليس كذلك". مات في المنفى في رانغون، ولم ير دلهي الحبيبة مرة أخرى.
            </p>
          </div>
        </div>
      </section>
  ...
  <div className="story-collection">
    ...
    <div className="epic-story">
      ...
      <div className="story-timeline">
        ...
        <div className="story-chapter">
          ...
          <p>
            للهرب من الاعتقال البريطاني، أُرسل الحاجي إلى **مكة بحجة الحج**. لمدة خمس 
        ...
        <div className="story-chapter">
          ...
          <p>
            عندما بدأت ثورة مالابار، أعلن الحاجي **"مالايالا راجيام"** (مملكة كيرالا) 
            في 28 أغسطس 1921. سيطر على **2000 ميل مربع** من الأراضي - 40% من جنوب مالابار! 
            أطلق على نفسه ألقاباً:
          </p>
          <ul className="royal-titles">
            <li>🤴 **ملك الهندوس**</li>
            <li>👑 **أمير المسلمين**</li>
            <li>⚔️ **عقيد جيش الخلافة**</li>
          </ul>
        </div>
        ...
        <div className="story-chapter">
          <h5>عدالة الحاكم</h5>
          <p>
            على عكس قادة الثوار العاديين، أدار الحاجي **حكومة متطورة**:
          </p>
          <ul>
            <li>📋 **أصدر جوازات سفر** للسفر داخل أراضيه</li>
            <li>💰 **أنشأ نظام ضرائب** لكنه أعفى الناس لعام 1921 بسبب معاناتهم</li>
            <li>⚖️ **عيّن ضباط إنفاذ قانون** يضمنون العدالة المتساوية لجميع الطوائف</li>
            <li>🏛️ **أنشأ محاكم** حيث كان يستمع شخصياً للقضايا</li>
          </ul>
          
          <div className="justice-story">
            <strong>حادثة البنك:</strong> عندما نهب مقاتلون مارقون بنك نامبوثيري 
            في مانجيري، أحاطت قوات الحاجي بالبنك فوراً و**أعادت كل شيء مسروق** 
        ...
        <div className="story-chapter">
          ...
          <p>
            ...
            من العقيد همفريز: **"أطلق عليّ النار من الأمام، بعيون غير مغطاة ويدين حرتين، 
            حتى أسقط على وجهي، محتضناً أرض وطني."** 
          </p>
          <p className="dramatic-end">
            البريطانيون، خوفاً من نمو أسطورته، **أحرقوا جثته ودمروا كل السجلات** 
    ...
    <div className="epic-story">
      ...
      <div className="story-narrative">
        <p>
          قضى علي مصلي **سبع سنوات يدرس في مكة** تحت إشراف علماء إسلاميين مشهورين، 
          وأصبح واحداً من أكثر القادة الدينيين تعلماً في عصره. لكن عندما **قُتل أخوه 
          وعدة أفراد من العائلة في 1896**، تحول هذا العالم المسالم إلى قائد ثوري.
        </p>

        <div className="turning-point">
          <h5>اللحظة التي غيرت كل شيء</h5>
          <p>
            في **20 أغسطس 1921**، عندما داهمت الشرطة البريطانية مسجد مامبورام في 
            تيرورانغادي وانتشرت إشاعات أنهم **دنسوا المبنى المقدس**، علم علي مصلي 
            أنه لا عودة إلى الوراء. في غضون ساعات، **أحاط 2000 مابيلا** بمركز الشرطة، 
            وبدأت الثورة.
          </p>
        </div>
        ...
        <div className="final-interview">
          ...
          <p>
            ...
            علي مصلي في سجن كويمباتور في **7 ديسمبر 1921**. صادر البريطانيون 
            **350 روبية** من صندوقه الشخصي لكنهم أظهروا فقط **17 روبية** في محاكمته
          ...
          <p>
            **شُنق في 21 فبراير 1922**، مختاراً الموت بدلاً من التسوية مع الحكم الاستعماري.
          </p>
        </div>
      </div>
    </div>
    ...
    <div className="epic-story">
      ...
      <div className="chittagong-story">
        <p>
          بينما يتذكر التاريخ **سوريا سن** كعقل مدبر لغارة مخزن أسلحة تشيتاغونغ، 
          قلة يعرفون عن **الثوريين المسلمين** الذين حاربوا إلى جانبه، مضحين 
        ...
        <div className="raid-details">
          ...
          <p>
            ...
            من **أكثر الهجمات جرأة** على مخازن أسلحة البريطانيين. شمل المقاتلون المسلمون:
          </p>
          <ul>
            <li>**رفاق أنانتا سنغ المسلمون** الذين ساعدوا في قطع خطوط الهاتف</li>
            <li>**شباب مسلمون محليون** وفروا بيوت آمنة للثوريين</li>
            <li>**عمال سكك حديد مسلمون** عطلوا شبكات الاتصال البريطانية</li>
          </ul>
        </div>
        ...
        <div className="torture-resistance">
          ...
          <p>
            عندما قُبض عليهم، تعرض هؤلاء الثوريون المسلمون لـ**تعذيب مروع** 
            من قبل الشرطة البريطانية. ضُربوا بقضبان حديدية، ونُزعت أظافرهم، 
            وعُلقوا مقلوبين لساعات. ومع ذلك **لم يكشف أحد منهم معلومات** 
        ...
        <div className="sacrifice-legacy">
          ...
          <p>
            مات عدة ثوريين مسلمين في الحجز البريطاني، أسماؤهم **ضاعت في التاريخ** 
            لكن تضحيتهم يتذكرها الناجون. تعرضت عائلاتهم للمضايقة، وصُودرت 
            ممتلكاتهم، ومع ذلك لم يندموا أبداً على اختيارهم للقتال من أجل **بهارات ماتا**.
          </p>
        </div>
      </div>
    </div>
    ...
    <div className="epic-story">
      ...
      <div className="musician-story">
        <p>
          في **15 أغسطس 1947**، عندما رُفع العلم الهندي ثلاثي الألوان في القلعة الحمراء، 
          ملأت **نغمات الشهناي العذبة** الهواء، عزفها الأستاذ بسم الله خان في **راغ كافي**. 
        ...
        <div className="pre-independence">
          ...
          <p>
            أثناء النضال من أجل الحرية، عزف بسم الله خان سراً في **اجتماعات الكونغرس** 
            و**التجمعات السرية**، وأصبحت موسيقاه **موسيقى المقاومة التصويرية**. 
        ...
        <div className="independence-day">
          ...
          <p>
            **اختار بانديت نهرو شخصياً** بسم الله خان للعزف في حفل الاستقلال. 
            وهو يعزف من أسوار القلعة الحمراء، **انسابت الدموع على وجهه** - 
        ...
        <div className="later-struggles">
          ...
          <p>
            رغم حصوله على بهارات راتنا والشهرة الدولية، مات بسم الله خان في **ضائقة مالية**. 
            أمنيته الأخيرة - أن يعزف في بوابة الهند للشهداء - بقيت بلا تحقيق. بعد موته، 
            **صهر أفراد عائلته شهناياته الفضية لكسب المال**، رمزاً لمدى سرعة نسيان الأمة لأبطالها.
          </p>
        </div>
      </div>
    </div>
    ...
    <div className="epic-story">
      ...
      <div className="mother-story">
        <p>
          **عابدي بانو بيغم**، المعروفة باسم بي أما، كانت أم **محمد علي وشوكت علي** - 
          الأخوين علي المشهورين. لكنها كانت أكثر من مجرد أم؛ كانت **القوة الدافعة** 
        ...
        <div className="leading-movement">
          ...
          <p>
            عندما **سُجن كلا ولديها من قبل البريطانيين**، لم تتراجع بي أما. بدلاً من ذلك، 
            تولت عملهما، وخاطبت **تجمعات ضخمة في كل أنحاء الهند**. صُدمت السلطات البريطانية 
            لرؤية آلاف الناس - رجال ونساء، شباب وكبار - متعلقين بكل كلمة من هذه 
            **المرأة المسلمة العجوز**.
          </p>
          <p>
            كانت خطاباتها قوية جداً لدرجة أن **البريطانيين اعتبروها أخطر** من كثير 
            من القادة الرجال، لأنها تستطيع تحريك **الجماهير المسلمة** كلا أحد غيرها.
          </p>
        </div>
        ...
        <div className="final-sacrifice">
          ...
          <p>
            أصبحت هذه **المرأة البالغة من العمر 73 عاماً** رمزاً لـ**تضحية الأمومة** 
